...
draw_text(points[0].x+128,points[0].y-128,"Use "+
get_key_name(global.keyboardBinds.attacking.up)+
get_key_name(global.keyboardBinds.attacking.left)+
get_key_name(global.keyboardBinds.attacking.down)+
get_key_name(global.keyboardBinds.attacking.right)+" to hit logs depending on what direction it is to the player")
...
draw_text(points[2].x+128,points[2].y-128,"Use "+
get_key_name(global.keyboardBinds.turning.up)+
get_key_name(global.keyboardBinds.turning.left)+
get_key_name(global.keyboardBinds.turning.down)+
get_key_name(global.keyboardBinds.turning.right)+" to hit arrows")

...
if(_file==false)
{
	global.levels=[
		...
		{name:"That one song that goes DADADADADA",artist:"That one guy that made it",path: working_directory+"That one song that goes DADADADADA\\data.json",difficulty:4,highScore:0,rank:""},
	]
	global.offset=0
}
else
